<template>
  <div id="audio" class="player-wrapper">
    <div :class="this.loading ? 'player-l':'player'">
      <span>{{ data.artist }}</span>
      <p class="play-title">{{ data.name }}</p>
      <v-skeleton-loader class="play-loader" v-if="this.loading" type="text" width="90%"/>
      <v-skeleton-loader class="play-loader" v-if="this.loading" type="text" width="70%"/>
      <div v-if="!this.loading" class="player-controls">
        <div class="audio">
          <div>
            <div
              v-on:click="seek"
